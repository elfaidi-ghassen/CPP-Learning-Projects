...
public:
    ...
    static vector <clsCurrency> loadCurrencies() {
        fstream MyFile;
        ...
        if (MyFile.is_open())
        {
            ...
            {
                currencies.push_back(_ConvertLinetoCurrencyObject(DataLine));
            }
    ...
    void printInfo() {
        ...
        std::cout << "Code: " << _CurrencyCode << "\n";
        std::cout << "Name: " << _CurrencyName << "\n";
        std::cout << "Rate(/$): " << _Rate << "\n";
        std::cout << "___________________________\n";

    }

    float convertInto(clsCurrency currency) {
